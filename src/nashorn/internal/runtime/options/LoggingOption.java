...
/**
 * Class that collects logging options like --log=compiler:finest,fields,recompile:fine into a map form that can be used to instantiate loggers in the Global object on demand.
 */
public class LoggingOption extends KeyValueOption {

    /**
     * Logging info.
     * Basically a logger name maps to this, which is a tuple of log level and the "is quiet" flag, which is a special log level used to collect RuntimeEvents only, but not output anything
     */
