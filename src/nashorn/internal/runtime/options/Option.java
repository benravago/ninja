 ...
 *
 * However, it is conceivable that the option, when set should run some initializations (for example, the logger system) or carry some other kind of payload, arrays, Collections, etc.
 * In that case, this should be subclassed
 *
