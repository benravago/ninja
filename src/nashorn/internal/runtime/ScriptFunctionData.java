 ...
 *
 * Instances of this class are created during codegen and stored in script classes' constants array to reduce function instantiation overhead during runtime.
 */
public abstract class ScriptFunctionData implements Serializable {
    ...
    /**
     * Return the complete internal function name for this data, not anonymous or similar.
     * May be identical
    ...
    /**
     * Returns true if this is a non-built-in function that requires non-primitive this argument according to ECMA 10.4.3.
    ...
    final MethodHandle getGenericConstructor(ScriptObject runtimeScope) {
        // This method has race conditions both on genericsInvoker and genericsInvoker.constructor, but even if invoked concurrently, they'll create idempotent results, so it doesn't matter.
        // We could alternatively implement this using java.util.concurrent.AtomicReferenceFieldUpdater, but it's hardly worth it.
        var lgenericInvokers = ensureGenericInvokers();
     ...
     */
    private Object convertThisObject(Object thiz) { // TODO: maybe remove
    ...
    Object invoke(ScriptFunction fn, Object self, Object... arguments) throws Throwable {
        ...
        if (needsCallee(mh)) {
            return switch (paramCount) {
                ...
                case 3 -> mh.invokeExact(fn, selfObj, getArg(args, 0));
                case 4 -> mh.invokeExact(fn, selfObj, getArg(args, 0), getArg(args, 1));
                case 5 -> mh.invokeExact(fn, selfObj, getArg(args, 0), getArg(args, 1), getArg(args, 2));
                case 6 -> mh.invokeExact(fn, selfObj, getArg(args, 0), getArg(args, 1), getArg(args, 2), getArg(args, 3));
                case 7 -> mh.invokeExact(fn, selfObj, getArg(args, 0), getArg(args, 1), getArg(args, 2), getArg(args, 3), getArg(args, 4));
                case 8 -> mh.invokeExact(fn, selfObj, getArg(args, 0), getArg(args, 1), getArg(args, 2), getArg(args, 3), getArg(args, 4), getArg(args, 5));
        ...
        return switch (paramCount) {
            ...
            case 2 -> mh.invokeExact(selfObj, getArg(args, 0));
            case 3 -> mh.invokeExact(selfObj, getArg(args, 0), getArg(args, 1));
            case 4 -> mh.invokeExact(selfObj, getArg(args, 0), getArg(args, 1), getArg(args, 2));
            case 5 -> mh.invokeExact(selfObj, getArg(args, 0), getArg(args, 1), getArg(args, 2), getArg(args, 3));
            case 6 -> mh.invokeExact(selfObj, getArg(args, 0), getArg(args, 1), getArg(args, 2), getArg(args, 3), getArg(args, 4));
            case 7 -> mh.invokeExact(selfObj, getArg(args, 0), getArg(args, 1), getArg(args, 2), getArg(args, 3), getArg(args, 4), getArg(args, 5));
    ...
    Object construct(ScriptFunction fn, Object... arguments) throws Throwable {
        ...
        if (needsCallee(mh)) {
            return switch (paramCount) {
                ...
                case 2 -> mh.invokeExact(fn, getArg(args, 0));
                case 3 -> mh.invokeExact(fn, getArg(args, 0), getArg(args, 1));
                case 4 -> mh.invokeExact(fn, getArg(args, 0), getArg(args, 1), getArg(args, 2));
                case 5 -> mh.invokeExact(fn, getArg(args, 0), getArg(args, 1), getArg(args, 2), getArg(args, 3));
                case 6 -> mh.invokeExact(fn, getArg(args, 0), getArg(args, 1), getArg(args, 2), getArg(args, 3), getArg(args, 4));
                case 7 -> mh.invokeExact(fn, getArg(args, 0), getArg(args, 1), getArg(args, 2), getArg(args, 3), getArg(args, 4), getArg(args, 5));
        ...
        return switch (paramCount) {
            ...
            case 1 -> mh.invokeExact(getArg(args, 0));
            case 2 -> mh.invokeExact(getArg(args, 0), getArg(args, 1));
            case 3 -> mh.invokeExact(getArg(args, 0), getArg(args, 1), getArg(args, 2));
            case 4 -> mh.invokeExact(getArg(args, 0), getArg(args, 1), getArg(args, 2), getArg(args, 3));
            case 5 -> mh.invokeExact(getArg(args, 0), getArg(args, 1), getArg(args, 2), getArg(args, 3), getArg(args, 4));
            case 6 -> mh.invokeExact(getArg(args, 0), getArg(args, 1), getArg(args, 2), getArg(args, 3), getArg(args, 4), getArg(args, 5));
