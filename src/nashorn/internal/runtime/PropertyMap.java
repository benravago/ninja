...
public class PropertyMap implements Iterable<Object>, Serializable {
     ...
     */
    public static PropertyMap newMap(Collection<Property> properties, String className, int fieldCount, int fieldMaximum,  final int spillLength) {
    ...
    /**
     * Method called when a property of an object using this property map is being created, modified, or deleted.
     * If a switchpoint for the property exists it will be invalidated.
     ...
     * If such a switchpoint exists, it will be invalidated when the property is modified in an object using this map.
     * This method returns {@code null} if no swichpoint exists for the property.
    ...
    /**
     * Add a property to the map, re-binding its getters and setters, if available, to a given receiver.
