...
public final class GlobalConstants implements Loggable {
     ...
     * Script objects require a receiver guard, which is memory intensive, so this is currently disabled. We might implement a weak reference based approach to this later.
     */
     ...
     * This is used from the class cache.
     * We _can_ reuse the same class for a new global, but the builtins and global scoped variables will have changed.
     */
