...
public abstract class Property implements Serializable {
    ...
    /**
     * Check whether this property has a user defined setter function.
     * See {@link UserAccessorProperty}
     ...
     * If this method returns {@code true} get and set operations will be delegated to a statically bound object instead of the object passed as parameter.
     */
     ...
     * Properties are immutable here, so any property change that results in a larger flag set results in the property being cloned.
     ...
     * Use {@link #getLocalType()} to always get the type of the actual value stored in the property slot.</p>
