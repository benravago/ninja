 ...
 *
 * <p>
 * The JVM defines a very small set of characters which are illegal in name spellings.
 * We will slightly extend and regularize this set into a group of <cite>dangerous characters</cite>.
 ...
 * <p>
 * Dangerous characters are the union of all characters forbidden or otherwise restricted by the JVM specification, plus their mates, if they are brackets (<code><b>[</b></code> and <code><b>]</b></code>,<code><b>&lt;</b></code> and <code><b>&gt;</b></code>), plus, arbitrarily, the colon character <code><b>:</b></code>.
 ...
 * <p>
 * The dangerous characters are <code><b>/</b></code> (forward slash, used to delimit package components), <code><b>.</b></code> (dot, also a package delimiter), <code><b>;</b></code> (semicolon, used in signatures), <code><b>$</b></code> (dollar, used in inner classes and synthetic members), <code><b>&lt;</b></code> (left angle), <code><b>&gt;</b></code> (right angle), <code><b>[</b></code> (left square bracket, used in array types), <code><b>]</b></code> (right square bracket, reserved in this scheme for language use), and <code><b>:</b></code> (colon, reserved in this scheme for language use).
 *
 * Their replacements are, respectively, <code><b>|</b></code> (vertical bar), <code><b>,</b></code> (comma), <code><b>?</b></code> (question mark), <code><b>%</b></code> (percent), <code><b>^</b></code> (caret), <code><b>_</b></code> (underscore), and <code><b>{</b></code> (left curly bracket), <code><b>}</b></code> (right curly bracket), <code><b>!</b></code> (exclamation mark).
 *
 * In addition, the replacement character for the escape character itself is <code><b>-</b></code> (hyphen), and the replacement character for the null prefix is <code><b>=</b></code> (equal sign).
 *
 * <p>
 ...
 * <li>If the first two steps introduced any change, <em>and</em> if the string does not already begin with a backslash, prepend a null prefix (<code><b>\=</b></code>).
 * </ol>
 *
 ...
 * Three examples of invalidly mangled strings are <code><b>\=foo</b></code>, <code><b>\-bar</b></code>, and <code><b>baz\!</b></code>, which demangle to <code><b>foo</b></code>, <code><b>\bar</b></code>, and <code><b>baz\!</b></code>, but then remangle to <code><b>foo</b></code>, <code><b>\bar</b></code>, and <code><b>\=baz\-!</b></code>.
