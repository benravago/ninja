...
public final class RewriteException extends Exception {
     ...
     * The array might have less elements, and some elements might be unnamed (the name can be null).
     * The information is provided in an effort to assist evaluation of expressions for their types by the compiler doing the deoptimizing recompilation, and can thus be incomplete - the more complete it is, the more expressions can be evaluated by the compiler, and the more unnecessary deoptimizing compilations can be avoided.
    ...
    /**
     * @return an array of continuation entry points that were already executed during one logical invocation of the function (a rest-of triggering a rest-of triggering a...)
     */
