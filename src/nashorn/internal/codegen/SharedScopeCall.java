 ...
 * <p>
 * Shared scope calls are not used if the scope contains a <code>with</code> statement or a call to <code>eval</code>.
 */
class SharedScopeCall {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SharedScopeCall) {
            var c = (SharedScopeCall) obj;
            return symbol.equals(c.symbol) && flags == c.flags && returnType.equals(c.returnType) && Arrays.equals(paramTypes, c.paramTypes) && isOptimistic == c.isOptimistic;
        }
        return false;
    }
