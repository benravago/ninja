 ...
 *
 * JoinPredecessor only provides a getter and setter for a {@link LocalVariableConversion}; the semantics of control flow for a particular node implementing the interface are shared between {@code LocalVariableTypesCalculator} that creates the conversions, and {@code CodeGenerator} that uses them.
 */
