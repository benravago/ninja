 ...
 *
 * This is needed as we sometimes have to save the setting of flags in the lexical context until a block is completely finished and its final version (after multiple copy on writes) is placed in the lexical context
 *
