...
public abstract class JumpStatement extends Statement implements JoinPredecessor {
     ...
     * Note that the parameter 'target' need not be the target of this jump statement, as the method can retrieve a label on any passed target as long as the target has a label of the requisite kind.
